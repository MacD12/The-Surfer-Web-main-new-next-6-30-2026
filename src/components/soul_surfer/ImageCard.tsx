...
// Using booking_engine/soulcamp*.jpg as placeholders until dedicated
// /public/soul_surfer/ photos are supplied.
const GALLERY = [
  {
    src: '/booking_engine/soulcamp2.jpg',
    tag: 'Rooftop Pool',
    alt: 'Rooftop infinity pool overlooking the ocean',
  },
  {
    src: '/booking_engine/soulcamp3.jpg',
    tag: 'Sea-view Dining',
    alt: 'Sea-view rooftop restaurant',
  },
  {
    src: '/soul_camp/room-4.jpg',
    tag: 'New Rooms',
    alt: 'Brand new private rooms',
  },
];

const ImageCard = () => {
  return (
    <section className="relative py-12 sm:py-14 md:py-16 bg-white overflow-hidden">
