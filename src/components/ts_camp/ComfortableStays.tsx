...
type RoomKey = 'dormitory' | 'singleRoom' | 'doubleRoom' | 'tripleRoom';

type Room = {
  key: RoomKey;
  cardKey: 'mixed' | 'single' | 'double' | 'triple';
  altKey: 'mixedDorm' | 'single' | 'double' | 'triple';
  capacity: string;
};

const ROOMS: Room[] = [
  { key: 'dormitory', cardKey: 'mixed', altKey: 'mixedDorm', capacity: 'Up to 5 guests' },
  { key: 'singleRoom', cardKey: 'single', altKey: 'single', capacity: '1 guest' },
  { key: 'doubleRoom', cardKey: 'double', altKey: 'double', capacity: '2 guests' },
  { key: 'tripleRoom', cardKey: 'triple', altKey: 'triple', capacity: '3 guests' },
];
            ...
            >
              <div className="relative">
                <RoomImageSlider
                  ...
                  altText={t(`comfortableStays1.alt.${room.altKey}`)}
              ...
              <div className="flex-1 flex flex-col p-5">
                <h3 className="font-[montserrat] text-base sm:text-lg font-bold tracking-tight text-gray-900 text-center leading-tight">
                  {t(`comfortableStays1.cards.${room.cardKey}.title`)}
                </h3>
                <p className="mt-2 text-xs sm:text-sm text-gray-500 leading-relaxed text-center">
                  {t(`comfortableStays1.cards.${room.cardKey}.body`)}
                </p>
              </div>
            </motion.div>
          ))}
