...
const GALLERY = [
  { src: '/beach_camp/image_1.jpg', tag: 'Rooftop' },
  { src: '/beach_camp/I3.jpg', tag: 'Pool Deck' },
  { src: '/beach_camp/11.jpg', tag: 'Camp Front' },
];

const ImageCard = () => {
  const { t } = useTranslation();
  const images = t('imageCard.images', { returnObjects: true }) as { alt: string }[];
  ...
  return (
    <section className="relative py-12 sm:py-14 md:py-16 bg-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          A look around our home in Weligama
        </motion.h2>
          ...
          {GALLERY.map((img, i) => (
            ...
            >
              <div className="relative aspect-[4/3]">
                <Image
                  src={img.src}
                  alt={images?.[i]?.alt || `Beach Camp view ${i + 1}`}
                  fill
