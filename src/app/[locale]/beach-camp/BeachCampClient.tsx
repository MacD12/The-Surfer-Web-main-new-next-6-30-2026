...
export default function BeachCampClient() {
  return (
    <div>
      <Header />
      <LifeAtSurfCamp />
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <motion.p
            ...
            viewport={{ once: true, amount: 0.5 }}
          >
            Steps from the sand, minutes from the breaks. Walk barefoot to your morning surf and stroll back for sunset on the rooftop.
          </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6 items-start">
            ...
            >
              ...
              <div className="absolute inset-x-3 bottom-3 sm:inset-x-5 sm:bottom-5 z-[400] flex flex-wrap items-center justify-between gap-3 rounded-2xl bg-white/95 backdrop-blur-md ring-1 ring-black/5 shadow-lg p-3 sm:p-4 pointer-events-none">
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=5.9698228%2C80.4468871&destination_place_id=ChIJ8T3AnVsVrjsR7EwuLk09pb8"
                  target="_blank"
            ...
            {/* NAP location card - visible address + plus code + microdata
                so local-pack crawlers can extract the same facts as the JSON-LD. */}
            <CampLocationCard
              campName="The Surfer Beach Camp"
              ...
              googleMapsUrl="https://www.google.com/maps/place/The+Surfer+Surf+Camps+Sri+Lanka/@5.9698228,80.4468871,17z"
            />
          </div>
        </div>
      </section>
