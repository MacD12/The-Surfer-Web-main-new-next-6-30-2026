...
export default function StyleCampClient() {
  return (
    <div>
      <Header />
      <LifeAtSurfCamp />
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          >
            Find us on the cliffs of Tamraght
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true, amount: 0.5 }}
          >
            A short ride from Agadir airport, minutes from Anchor Point and Killer Point - surf in the morning, mint tea in a Tamraght café by afternoon.
          </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6 items-start">
            ...
            >
              ...
              <CampsMap camps={SURFSTYLE_CAMP_PIN} />
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <span className="block font-[montserrat] text-sm sm:text-base font-bold tracking-tight text-gray-900 leading-tight truncate">
                      Tamraght · Atlantic Coast, Morocco
                    </span>
                  </div>
                </div>
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=30.5165125%2C-9.6817112&destination_place_id=ChIJfYpk3UAwO9sRmceK1lKAem4"
                  target="_blank"
            ...
            <CampLocationCard
              ...
              googleMapsUrl="https://www.google.com/maps/place/Surf+Style+Morocco/@30.5165125,-9.6817112,17z"
            />
          </div>
        </div>
      </section>
